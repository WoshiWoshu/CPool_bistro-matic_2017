...
void decimal_to_octal_man_ascii(unsigned int x);
int decimal_to_octal_condition_man_ascii(char *array, int i);
int decimal_to_octal_condition(char *array, int i);
...
int my_printf_condition_content_part_1(int i, const char *format, va_list ap);
int my_printf_condition_content_part_2(int i, const char *format, va_list ap);
int my_printf_condition_content_part_3(int i, const char *format, va_list ap);
int my_printf_condition_content_part_01(int i, const char *format);
...
int decimal_to_hexadecimal_first_condition_x_maj(unsigned int x1, char x2);
int decimal_to_hexadecimal_while_loop_content(unsigned int x1,
	unsigned int x2);
int flag_u(int i, va_list ap);
int decimal_to_hexa_while_content_x_maj(unsigned int x1, unsigned int x2);
...
void decimal_to_hexadecimal_x_maj(unsigned int x);
